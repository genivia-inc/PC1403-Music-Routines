...
rdata:
	...
	;cpia 0			;check if drum is active (ania 0x03 sets z flag) NOTE: removed
	jrzp nodrum
	call drum		;play drum
...
playDrum:
	...
	orim 0x10	;4	;1	;beeper on
	outc		;2	;1
dwait1:
	deca		;(4)	;1
	jrnzm dwait1	;(7)/4	;2	sum=11*sum_of_odd_bytes

	anim 0		;4	;2	;mask for beeper off NOTE: was anim 0xef why? NOTE: could EXAM since A=0
	ixl		;7	;1	;load next counter value	
	cpma		;3	;1	;if it is 0
